...
class CustomerServiceTest {
    ...
    void setUp() {
        ...
        customerPayload = TestDataCustomerPayload.Customer("test name", "test password", "test@email.store", true, true);
    }
    ...
    void should_return_customer_when_id_is_exist_test() {
        ...
        // when
        CustomerPayload customerPayloadReturnedFromService = customerService.getById(id);
    ...
    void should_add_customer_when_payload_is_correct_test() {
        ...
        CustomerEntity customerEntity = payloadsConverter.convertCustomer(customerPayload, null);
    ...
    void should_edit_customer_when_payload_is_correct_test() {
        ...
        CustomerEntity existingCustomer = payloadsConverter.convertCustomer(customerPayload, idExist);
