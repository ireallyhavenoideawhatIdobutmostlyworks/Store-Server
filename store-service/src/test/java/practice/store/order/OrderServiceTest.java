...
class OrderServiceTest {
    ...
    void setUp() {
        ...
        orderService = new OrderService(orderRepository, customerRepository, productRepository, orderProductRepository, payloadsConverter, generateRandomString, orderValidator, productService, senderMailService, senderPdfService);
